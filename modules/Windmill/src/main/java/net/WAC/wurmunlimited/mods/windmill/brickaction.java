...
public class brickaction implements WurmServerMod, ItemTypes, MiscConstants, ModAction, BehaviourProvider, ActionPerformer {
   ...
   public brickaction() {
      ...
      actionEntry = ActionEntry.createEntry(actionId, "Create bricks", "Creating bricks", new int[0]);
   ...
   public List<ActionEntry> getBehavioursFor(Creature performer, Item target) {
      return performer instanceof Player && target.getTemplateId() == windmill.masonsmilltemplateid ? Arrays.asList(actionEntry) : null;
   }
