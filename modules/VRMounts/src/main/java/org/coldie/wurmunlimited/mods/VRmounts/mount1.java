...
public class mount1 implements ModCreature, CreatureTypes {
    public static int templateId;
    
    @Override
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        final int[] types = new int[] {2,3,9,12,14,27,30,32,38,41,42,43,62};
        final CreatureTemplateBuilder builder = new CreatureTemplateBuilder(
                "mod.creature.quadraped.horse.goldbuckskin", "Mustang", VRmounts.examinemessage,
                ...
                1.0F, 1.0F, 2.5F, 1.5F, 2.0F, 0.0F, 0.2F, 400,
